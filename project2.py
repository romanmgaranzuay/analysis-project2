...
# def compute_distances(queries, stores):
#     distances = []
...
def main():
    ...
    # For each query, compute and store distances to all Starbucks
    for query in queries:
    ...
    for query in queries:
        ...
        if n > i:
            ...
            print(f"The {i+1} closest stores to ({query.latitude}, {query.longitude}):")
